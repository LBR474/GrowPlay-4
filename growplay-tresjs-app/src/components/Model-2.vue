...
// ============================================================
// AFTER CLIMBING FRAME IS BUILT
// ROTATE 90° THEN MOVE OFF SCREEN
// ============================================================

const finalPieceDelay =
  3 + (pieces.length - 1) * 0.03;


const finalPieceFinished =
  finalPieceDelay + 0.5;


gsap.timeline({
  delay: finalPieceFinished,
})

  // ----------------------------------------------------------
  // ROTATE 90° ON THREE.JS Y AXIS
  // ----------------------------------------------------------
...
.to(
  climbingFrameGroup.position,
  {
    x: () => climbingFrameGroup.position.x - 5,
